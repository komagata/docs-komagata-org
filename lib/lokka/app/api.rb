...
module Lokka
  module Api
    def self.registered(app)
      ...
      app.delete '/api/v1/posts/:id' do |id|
        post = Post.find_by(id: id) || halt(404, { error: 'Not Found' }.to_json)
        post.destroy
        status 204
        ''
      ...
      app.delete '/api/v1/pages/:id' do |id|
        page = Page.find_by(id: id) || halt(404, { error: 'Not Found' }.to_json)
        page.destroy
        status 204
        ''
      ...
      app.put '/api/v1/categories/:id' do |id|
        category = Category.find_by(id: id) || halt(404, { error: 'Not Found' }.to_json)
      ...
      app.delete '/api/v1/categories/:id' do |id|
        category = Category.find_by(id: id) || halt(404, { error: 'Not Found' }.to_json)
        category.destroy
        status 204
        ''
      ...
      app.delete '/api/v1/tags/:id' do |id|
        tag = Tag.find_by(id: id) || halt(404, { error: 'Not Found' }.to_json)
        tag.destroy
        status 204
        ''
      ...
      app.put '/api/v1/comments/:id' do |id|
        comment = Comment.find_by(id: id) || halt(404, { error: 'Not Found' }.to_json)
      ...
      app.delete '/api/v1/comments/:id' do |id|
        comment = Comment.find_by(id: id) || halt(404, { error: 'Not Found' }.to_json)
        comment.destroy
        status 204
        ''
      ...
      app.put '/api/v1/snippets/:id' do |id|
        snippet = Snippet.find_by(id: id) || halt(404, { error: 'Not Found' }.to_json)
      ...
      app.delete '/api/v1/snippets/:id' do |id|
        snippet = Snippet.find_by(id: id) || halt(404, { error: 'Not Found' }.to_json)
        snippet.destroy
        status 204
        ''
